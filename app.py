...
def handle_message(event):
    ...
    if text == 'buttons' or text == '按鈕':
        ...
        carousel_template = CarouselTemplate(columns=[
            ...
            CarouselColumn(text='公館',thumbnailImageUrl = 'https://photos.app.goo.gl/N7Dev9mZD98Qqbfv7', actions=[
                MessageAction(label='飯', text='公館_飯'),
                MessageAction(label='麵', text='公館_麵'),
                MessageAction(label='其他', text='公館_其他')
            ]),
            CarouselColumn(text='溫州',thumbnailImageUrl = 'https://photos.app.goo.gl/N7Dev9mZD98Qqbfv7', actions=[
                MessageAction(label='飯', text='溫州_飯'),
                MessageAction(label='麵', text='溫州_麵'),
                MessageAction(label='其他', text='溫州_其他')
            ]),
            CarouselColumn(text='後門',thumbnailImageUrl = 'https://photos.app.goo.gl/N7Dev9mZD98Qqbfv7', actions=[
